...
- (void)addChildViewControllers{
    ...
    [self addChildVc:lockVC title:@"我的门锁" image:@"tabbar_mylock_normal" selectedImage:@"tabbar_mylock_select"];
    [self addChildVc:catEyeVC title:@"我的猫眼" image:@"tabbar_mycateye_normal" selectedImage:@"tabbar_mycateye_select"];
    [self addChildVc:gatewayVC title:@"网关" image:@"tabbar_mygateway_normal" selectedImage:@"tabbar_mygateway_select"];
