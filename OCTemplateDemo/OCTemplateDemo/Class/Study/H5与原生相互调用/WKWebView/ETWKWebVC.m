...
#import "WeakWebViewScriptObject.h"

@interface ETWKWebVC () <WKScriptMessageHandler, WKUIDelegate, WKNavigationDelegate>
...
- (UIProgressView *)progressView
{
    if (!_progressView){
        ...
        _progressView = [[UIProgressView alloc] initWithFrame:CGRectMake(0, statusBarHeight + 44, self.view.frame.size.width, 2)];
...
- (WKWebView *)webView{
    ...
    if(_webView == nil){
        ...
        WeakWebViewScriptObject *weakScriptMessageDelegate = [[WeakWebViewScriptObject alloc] initWithDelegate:self];
        ...
        NSString *htmlString = [[NSString alloc]initWithContentsOfFile:path encoding:NSUTF8StringEncoding error:nil];
        [_webView loadHTMLString:htmlString baseURL:[NSURL fileURLWithPath:[[NSBundle mainBundle] bundlePath]]];
        //        [_webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://www.chinadaily.com.cn"]]];
